...
const u08 numberOfObjectsReg = 0x42;
...
const u08 objectLR_X_Reg[8] = {0x46, 0x4B, 0x50, 0x55, 0x5A, 0x5F, 0x64, 0x69};
const u08 objectLR_Y_Reg[8] = {0x47, 0x4C, 0x51, 0x56, 0x5B, 0x60, 0x65, 0x6A};
...
struct blobArray getBlobs(void)
{
    ...
    //u08 numAddress = 0x42;
    //blobs.length = readCameraRegister(numAddress);

    u08 r = 0x42;
    u08 regValue;
    i2cMasterSend(CAM_ADDRESS, 1, &r);
    _delay_ms(10);
